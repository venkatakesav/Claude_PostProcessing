...
def process_mistral(claude_annotations, ocr, output_path):
    ...
    with open(output_path, "a") as fp:  # Open file in append mode
        for entry in ocr:
            ...
            for annotation in claude_annotations:
                if annotation["file_name"] == file_name:
                    question_answer_pairs = annotation["question_answer_pairs"]
